<html lang="en">
        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
                <ol class="breadcrumb mt-3 align-items-center">
                    ...
                    <li class="breadcrumb-item active"><h3><span class="badge bg-success">Configurare produse ecrane</span></h3></li>
                </ol>
            </nav>
            ...
            <div class="mb-3 col-sm-6">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="zeroStockProducts">
                    <label class="form-check-label" for="zeroStockProducts">
                        Produse stoc 0
                    </label>
                </div>
            </div>
    ...
    <script>
        ...
        function createTableWithProducts(productList) {
            ...
            let showStockZero = $('#zeroStockProducts').is(':checked');
            ...
            for (let i = 0; i < productList.length; i++) {
                ...
                index += 1;
                tr.append($('<th></th>').text(index).attr('scope', 'row'));
        ...
        $(document).ready(function() {
            ...
            $("#zeroStockProducts").change(function() {
                getDisplaySelectionAndPopulateTable();
            });
